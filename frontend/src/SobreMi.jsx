...
export default function SobreMi() {
  ...
  return (
    <div className="w-2/3 relative top-30 mt-16 flex flex-col gap-8 justify-center items-center fira-code ">
      ...
      <div className="flex text-center gap-16 items-center">
        <div>
          ...
          <p className="text-lg text-center max-w-2xl text-white">
            ...
            oportunidades para mejorar mis habilidades. Soy un desarrollador web
            apasionado por la tecnología y el aprendizaje continuo. Me encanta
            crear aplicaciones web que sean funcionales y atractivas. Siempre
