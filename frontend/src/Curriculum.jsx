...
export default function Curriculum() {
  ...
  const tecnologias = [
    { nombre: "HTML", icono: <FaHtml5 className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "CSS", icono: <FaCss3Alt className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "JavaScript", icono: <IoLogoJavascript className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "Python", icono: <FaPython className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "React.js", icono: <FaReact className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "Node.js", icono: <DiNodejs className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "Express.js", icono: <SiExpress className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "Supabase", icono: <RiSupabaseFill className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "Tailwind", icono: <RiTailwindCssFill className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "Bootstrap", icono: <FaBootstrap className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "Git", icono: <FaGitAlt className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
    { nombre: "MySQL", icono: <FaDatabase className="lg:!text-[2.2rem] 2xl:!text-[3.9rem]" /> },
  ];
  return (
    <>
      <div
            ...
            <div className="w-full h-[20vh] flex justify-center items-center rounded-2xl text-black !border-1 !border-gray-300 bg-[#F2F2F2] hover:shadow-sm dark:hover:shadow-gray-700 dark:!border-gray-600 dark:bg-[#242424] dark:text-white">
              <div className="w-[90%] h-[82%] flex flex-col lg:gap-2 2xl:gap-6">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="!font-bold nata-sans text-gray-800 dark:text-white lg:!text-[1rem] 2xl:!text-[1.5rem]">Sobre mí</h3>
                </div>
                <p
                  className="text-gray-700 dark:text-gray-300 nata-sans lg:!text-[0.6rem] 2xl:!text-[0.9rem]"
                >
            ...
            <div className="w-full h-[40vh] flex justify-center items-center rounded-2xl text-black !border-1 !border-gray-300 bg-[#F2F2F2] hover:shadow-sm dark:hover:shadow-gray-700 dark:!border-gray-600 dark:bg-[#242424] dark:text-white ">
              <div className="w-[90%] h-[90%] flex flex-col lg:gap-3 2xl:gap-8 ">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="!font-bold nata-sans text-gray-900 dark:text-white lg:!text-[1rem] 2xl:!text-[1.5rem]">
                    Experiencia laboral
                  </h3>
                </div>
                <div className="flex flex-col gap-2">
                  <p
                    className="text-gray-900 dark:text-gray-200 !font-semibold nata-sans lg:!text-[0.7rem] 2xl:!text-[0.9rem]"
                  >
                    AUXILIAR DE GESTIÓN DOCUMENTAL
                  </p>
                  <p
                    className="text-gray-900 dark:text-white monospace nata-sans lg:!text-[0.7rem] 2xl:!text-[0.9rem]"
                  >
            ...
            <div className="w-full h-[40vh] flex justify-center items-center rounded-2xl hover:shadow-sm dark:hover:shadow-gray-700 text-black !border-1 !border-gray-300 bg-[#F2F2F2] dark:!border-gray-600 dark:bg-[#242424] dark:text-white">
              <div className="w-[90%] h-[90%] flex flex-col gap-8 ">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="!font-bold nata-sans text-gray-900 dark:text-white lg:!text-[1rem] 2xl:!text-[1.5rem]">Stack</h3>
                </div>
                <div className="grid grid-cols-6 lg:gap-1 2xl:gap-4 mt-4">
                  {tecnologias.map((tecnologia, index) => (
                    <div
                      key={index}
                      className="flex flex-col items-center justify-center gap-4 lg:!px-6 lg:!py-2 2xl:!px-10.5 2xl:!py-4 dark:text-white dark:bg-[#292929] rounded-sm shadow-sm monospace transition-transform duration-300 hover:scale-105"
                    >
                      {tecnologia.icono}
            ...
            <div className="w-full h-[20vh] flex justify-center items-center rounded-2xl text-black !border-1 !border-gray-300 bg-[#F2F2F2] hover:shadow-sm dark:hover:shadow-gray-700 dark:!border-gray-600 dark:bg-[#242424] dark:text-white">
              <div className="w-[90%] h-[82%] flex flex-col lg:gap-2 2xl:gap-6 ">
                <div className="flex items-center gap-4">
                  ...
                  <h3 className="!font-bold nata-sans text-gray-900 dark:text-white lg:!text-[1rem] 2xl:!text-[1.5rem]">Formación</h3>
                </div>
                <div className="flex flex-col gap-2">
                  <p
                    className="text-black dark:text-white !font-semibold nata-sans lg:!text-[0.7rem] 2xl:!text-[0.9rem]"
                  >
                  ...
                  <p
                    className="text-gray-700 dark:text-gray-200 nata-sans lg:!text-[0.6rem] 2xl:!text-[0.9rem]"
                  >
                    2022 - Presente.
                  </p>
                </div>
